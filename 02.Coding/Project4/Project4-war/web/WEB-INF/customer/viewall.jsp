...
<style>
    ...
    a.dropdown-item:hover {
        background-customer: #6977c2 !important;
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <h4 class="page-title"><fmt:message bundle="${lang}" key="customerTable"/></h4>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                    <div class=""><i class="fa fa-table"></i> Data Customer</div>
                    <div class="icon-container" style="width: 20%"><span class="ti-pencil-alt" style="padding-top: 10px"></span><span class="icon-name"> <a href="<%= request.getContextPath()%>/file/customer/createcustomer" class="btn btn-info btn-round btn-block waves-effect waves-light m-1 btn-outline-success"><fmt:message bundle="${lang}" key="create"/></a></span></div>
                    <div class="">
                                ...
                                <tbody>
                                    <c:forEach items="${customers}" var="b">
                                        <tr style="text-align: center">
                                            ...
                                            <td>${b.customerGender}</td>
                                            <fmt:formatDate var="customerBirthday" value="${b.customerBirthday}" pattern="dd/MM/yyyy"/>
                                            <td>${customerBirthday}</td> 
                                            <td >
                                                <a href="<%= request.getContextPath()%>/file/customer/detail/${b.customerId}" style="customer: lightseagreen"  ><span class="ti-zoom-in" ></span> <fmt:message bundle="${lang}" key="detail"/></a>
                                                <a href="<%= request.getContextPath()%>/file/customer/editcustomer/${b.customerId}" style="color: lawngreen"><span class="ti-check-box" ></span> <fmt:message bundle="${lang}" key="edit"/></a>
                                                <a href="#" style="color: red!important" data-toggle="modal" data-target="#modal-animation-${b.customerId}" ><span class="ti-trash" ></span> <fmt:message bundle="${lang}" key="delete"/></a>
                                                <div class="modal fade" id="modal-animation-${b.customerId}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content animated zoomInUp">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-success" href="<%= request.getContextPath()%>/file/customer/delete/${b.customerId}"><i class="fa fa-check-square-o"></i> <fmt:message bundle="${lang}" key="delete"/></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
