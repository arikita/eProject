            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="editcustomer"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/customer/edit" commandName="customer" method="post">
                            <div class="row">
...
url: "${links}/file/customer/searchpro",
data: {
ids: idsearch
},
dataType: 'json',
