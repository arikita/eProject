...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <h4 class="page-title"><fmt:message bundle="${lang}" key="color"/></h4>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                    <div class=""><i class="fa fa-table"></i> Data Color</div>
                    <div class="icon-container" style="width: 20%"><span class="ti-pencil-alt" style="padding-top: 10px"></span><span class="icon-name"> <a href="<%= request.getContextPath()%>/file/color/createcolor" class="btn btn-info btn-round btn-block waves-effect waves-light m-1 btn-outline-success"><fmt:message bundle="${lang}" key="create"/></a></span></div>
                    <div class="">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered content" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach items="${colors}" var="b">
                                        <tr style="text-align: center">
                                            <td>${b.colorId}</td>
                                            <td>${b.colorName}</td>
                                            <td >
                                                <a href="<%= request.getContextPath()%>/file/color/editcolor/${b.colorId}" style="color: lawngreen"><span class="ti-check-box" ></span> <fmt:message bundle="${lang}" key="edit"/></a>
                                                <a href="#" style="color: red!important" data-toggle="modal" data-target="#modal-animation-${b.colorId}" ><span class="ti-trash" ></span> <fmt:message bundle="${lang}" key="delete"/></a>

                                                <div class="modal fade" id="modal-animation-${b.colorId}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content animated zoomInUp">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-success" href="<%= request.getContextPath()%>/file/color/delete/${b.colorId}"><i class="fa fa-check-square-o"></i> <fmt:message bundle="${lang}" key="delete"/></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
