            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="editadmin"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/admin/edit" commandName="admin" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <form:input  path="adminUsername" class="form-control" placeholder="${username}" disabled="true" />                    
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <img src="${links}/images/admin/${admin.adminPicture}" id="output" height="250" width="250" />
                                                                                        
                                            <input type="file" name="file" accept=".png, .jpg, .jpeg" onchange="loadFile(event)"/>
                                ...
                                <div>
                                    ...
                                    <form:input path="adminPassword" class="form-control"  hidden="true" />  
                                </div>
