            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="editsize"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/size/edit" commandName="size" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <form:input path="sizeSize" class="form-control" placeholder="${size}"/>                    
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input  type="submit" onclick="return  confirm('are you ok')" style="width: 150px" value="<fmt:message bundle="${lang}" key="edit"/>" id="submit" class="btn btn-outline-info  m-1">
                                    </div>
                                </div>                               
                            </div> 
                        </form:form>
...
<script type="text/javascript">
    $("#sizeSize").change(function () {
        $.ajax({
            ...
            url: "${links}/file/size/searchpro",
            data: {
                sizeedit: $("#sizeSize").val(),
                idedit: $("#sizeId").val(),
            },
            dataType: 'json',
            timeout: 100000,
