...
<fmt:setBundle basename="lang.edit" var="lang"/>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="editmembership"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/membership/edit" commandName="membership" method="post" enctype="multipart/form-data">
                            <div class="row">
