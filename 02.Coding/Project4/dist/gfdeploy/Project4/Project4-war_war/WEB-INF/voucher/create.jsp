            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="createavoucher"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/voucher/create" commandName="voucher" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        <form:label path="voucherKey"><fmt:message bundle="${lang}" key="keyvoucher"/></form:label>
