            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div><span class="ti-pencil-alt"></span> <fmt:message bundle="${lang}" key="editasalary"/> </div>

                    </div>

                    <div class="card-body">

                        <form:form action="${links}/file/salary/edit" commandName="salary" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        <form:label path="salaryOtherDetail"><fmt:message bundle="${lang}" key="detail"/></form:label>
                                        <fmt:message bundle='${lang}' key='detailinput' var="detail"/>
                                        <div class="input-group">
                                            <form:input path="salaryOtherDetail" class="form-control" placeholder="${detail}"/>                    
                                            <span class="input-group-text" ><i class="fa fa-spinner fa-spin"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <form:input path="salaryReduceDetail" class="form-control" placeholder="${reduceDetail}"/>                    
                                            <span class="input-group-text" ><i class="fa fa-spinner fa-spin"></i></span>
                                        </div>
                                    </div>
                                </div>
